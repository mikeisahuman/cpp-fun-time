...
while True :
	...
	OK = raw_input("Type 'OK' to continue, or 'nevermind' to quit:" + newLine)
	...
	A = float(raw_input(newLine + "What is your 'A'?" + newLine))
	B = float(raw_input("What is your 'B'?" + newLine))
	C = float(raw_input("What is your 'C'?" + newLine))
